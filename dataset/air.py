...
def get_airs_datasets(air_root, train_transform, test_transform, train_classes, unlab_classes, num_inc_sessions, prop_train_labels=0.8,
                    split_train_val=False, seed=0):

    np.random.seed(seed)
    # Init entire training set
    whole_training_set = Airs(root=air_root, transform=train_transform, train=True)
    ...
    #todo ============================================================================
    whole_test_set = Airs(root=air_root, transform=test_transform, train=False)
